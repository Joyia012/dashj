...
public class CoinDefinition {
    ...
    public static final String coinName = "Twins";
    public static final String coinTicker = "TWINS";
    public static final String coinURIScheme = "twins";
    ...
    public static final int Port    = 37817;       //protocol.h GetDefaultPort(testnet=false)
    public static final int TestPort = 1234;     //protocol.h GetDefaultPort(testnet=true)

    /** Zerocoin starting block height */
    public static final long TESTNET_ZEROCOIN_STARTING_BLOCK_HEIGHT = 201564;
    public static final long MAINNET_ZEROCOIN_STARTING_BLOCK_HEIGHT = 15000000;

    //
    //  Production
    //
    public static final int AddressHeader = 73;             //base58.h CBitcoinAddress::PUBKEY_ADDRESS
    public static final int p2shHeader = 83;             //base58.h CBitcoinAddress::SCRIPT_ADDRESS
    public static final int dumpedPrivateKeyHeader = 201;   //common to all coins
   // public static final long oldPacketMagic = 0xfbc0b6db;      //, 0xc0, 0xb6, 0xdb
    public static final long PacketMagic = 0x0ad31c2f;

    //Genesis Block Information from main.cpp: LoadBlockIndex
    static public long genesisBlockDifficultyTarget = 0x1e0ffff0;         //main.cpp: LoadBlockIndex
    static public long genesisBlockTime = 1546790318;                       //main.cpp: LoadBlockIndex
    static public long genesisBlockNonce = 348223;                         //main.cpp: LoadBlockIndex
    static public String genesisHash = "0000071cf2d95aec5ba4818418756c93cb12cd627191710e8969f2f35c3530de";  //main.cpp: hashGenesisBlock
    static public String genesisMerkleRoot = "4271a3d993d6157f960de646ce8dfad07989dfd0703064f8056d1a7287283d06";
    static public int genesisBlockValue = 50;                                                              //main.cpp: LoadBlockIndex
    //taken from the raw data of the block explorer
    static public String genesisTxInBytes = "04ffff001d01043642424320323031382f31322f333120476c6f62616c206d61726b65747320696e20776f72737420796561722073696e63652032303038";
    static public String genesisTxPubKey = "04c2851936b2196beb85e7eca91697884918bc6deacd4ca49b52418d376a092913bde42bc868178c0ed436c184259edd0bf2a3ff32388facd6d6332e8de31c9121";//"040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9";   
    ...
    public static final long testnetPacketMagic = 0x0ad31c2f;      //
    public static final String testnetGenesisHash =  "";
    static public long testnetGenesisBlockDifficultyTarget = (0x1e0ffff0);         //main.cpp: LoadBlockIndex
    static public long testnetGenesisBlockTime = 1546790318L;                       //main.cpp: LoadBlockIndex
    static public long testnetGenesisBlockNonce = (348223L);                         //main.cpp: LoadBlockIndex
    ...
    {
        int COIN = 1;
        Coin nSubsidy = Coin.valueOf(15220, 0);
        if (height == 1)
            nSubsidy = Coin.valueOf(6000000, 0);
        return nSubsidy;
    }
